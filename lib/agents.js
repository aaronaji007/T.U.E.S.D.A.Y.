...
const AGENTS = {
  coordinator: { name: 'SOC Coordinator', role: 'Swarm Orchestration & Task Decomposition', icon: 'fa-sitemap', color: '#00ff66', tools: ['episodic_search', 'ttp_lookup', 'sigma_scan', 'yara_scan', 'ioc_lookup', 'asset_lookup'] },
  log:         { name: 'Log Analysis', role: 'SIEM Correlation & Sigma Rules Engine', icon: 'fa-list-check', color: '#00f3ff', tools: ['sigma_scan', 'ttp_lookup', 'asset_lookup', 'episodic_search'] },
  threatintel: { name: 'Threat Intelligence', role: 'IOC Enrichment (VT, AbuseIPDB, Shodan, MISP)', icon: 'fa-globe', color: '#b55fe6', tools: ['ioc_lookup', 'episodic_search', 'ttp_lookup'] },
  malware:     { name: 'Malware Sandbox', role: 'YARA + Behavioral Sandbox Analysis', icon: 'fa-bug', color: '#ff007f', tools: ['yara_scan', 'ttp_lookup'] },
  cloud:       { name: 'Cloud Security', role: 'AWS/Azure IAM & CSPM Posture Audit', icon: 'fa-cloud', color: '#00e6b8', tools: ['asset_lookup', 'sigma_scan', 'ttp_lookup'] },
  response:    { name: 'Incident Response', role: 'Autonomous Containment & SOAR Playbooks', icon: 'fa-bolt', color: '#ff3b3b', tools: ['asset_lookup', 'ttp_lookup', 'episodic_search'] },
  compliance:  { name: 'Compliance Audit', role: 'Regulatory Impact & Cryptographic Audit Trail', icon: 'fa-scale-balanced', color: '#ffb700', tools: ['asset_lookup', 'ttp_lookup', 'episodic_search'] },
  approval:    { name: 'Human Governance', role: 'Risk Threshold Gate & Override Control', icon: 'fa-user-shield', color: '#00ff66', tools: ['asset_lookup', 'episodic_search'] }
};
